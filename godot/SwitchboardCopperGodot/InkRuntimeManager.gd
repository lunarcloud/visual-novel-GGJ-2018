...
export var json_story: String = "res://ink/main.json"
export var auto_continue_newline_text: bool = true
...
func save_state(file_name: String = "user://save.json"):
...
func load_state(file_name: String = "user://save.json"):
	var save_file = File.new()
	if save_file.file_exists(file_name):
