...
ig.Input = ig.Class.extend({
    ...
    initMouse: function() {
        ...
        ig.system.canvas.addEventListener('mousewheel', mouseWheelBound, {passive: true} );
        ig.system.canvas.addEventListener('DOMMouseScroll', mouseWheelBound, {passive: true} );
