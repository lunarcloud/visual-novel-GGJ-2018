...
ig.TouchButton = ig.Class.extend({
    ...
    align: function( w, h ) {
        ...
        this.anchor.left = Math.floor(this.anchor.left);
        this.anchor.right = Math.floor(this.anchor.right);
        this.anchor.top = Math.floor(this.anchor.top);
        this.anchor.bottom = Math.floor(this.anchor.bottom);

        this.pos.x = Math.floor(this.pos.x);
        this.area.x1 = Math.floor(this.area.x1);
        this.area.x2 = Math.ceil(this.area.x2);

        this.pos.y = Math.floor(this.pos.y);
        this.area.y1 = Math.floor(this.area.y1);
        this.area.y2 = Math.ceil(this.area.y2);
