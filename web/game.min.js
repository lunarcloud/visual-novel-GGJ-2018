...
options[menu.Page.MAIN].push(new ss.MenuImageOption(menu,this.images.note,function(){menu.inkStory.dailyMenuChosen("note");},544,340));if(show.wiley)
options[menu.Page.MAIN].push(new ss.MenuImageOption(menu,this.images.wiley,function(){menu.inkStory.dailyMenuChosen("wiley");},894,246));if(show.briggs)
options[menu.Page.MAIN].push(new ss.MenuImageOption(menu,this.images.briggs,function(){menu.inkStory.dailyMenuChosen("briggs");},1098,246));if(show.doherty)
options[menu.Page.MAIN].push(new ss.MenuImageOption(menu,this.images.doherty,function(){menu.inkStory.dailyMenuChosen("doherty");},894,466));var fourthX=1098;var fourthY=466;if(show.hughes){options[menu.Page.MAIN].push(new ss.MenuImageOption(menu,this.images.hughes,function(){menu.inkStory.dailyMenuChosen("hughes");},fourthX,fourthY));}
...
this.setNextMoment(inkstory.getNextMoment(choiceIndex));});this.ink.tagHandlers["portrait"]=function(key,character,position){if(!position)position="center";if(character==null||character=="none"){inkstory.currentPortrait=undefined;}else{inkstory.currentPortrait={character:character.toLowerCase(),position:position.toLowerCase()};}};this.ink.tagHandlers["background"]=function(key,name){inkstory.currentBackground=name==null||name=="none"?undefined:name;};this.ink.tagHandlers["music"]=function(key,title){if(title in ig.music.namedTracks){console.debug("🎵 "+title);}else{console.debug("🎵 ??"+title);return;}
