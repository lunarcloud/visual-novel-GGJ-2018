...
options[menu.Page.MAIN].push(new ss.MenuImageOption(menu,this.images.note,function(){menu.inkStory.dailyMenuChosen("note");},192,ig.system.height/3));if(show.wiley)
options[menu.Page.MAIN].push(new ss.MenuImageOption(menu,this.images.wiley,function(){menu.inkStory.dailyMenuChosen("wiley");},ig.system.width-352,ig.system.height-352));if(show.briggs)
options[menu.Page.MAIN].push(new ss.MenuImageOption(menu,this.images.briggs,function(){menu.inkStory.dailyMenuChosen("briggs");},ig.system.width-192,ig.system.height-352));if(show.doherty)
options[menu.Page.MAIN].push(new ss.MenuImageOption(menu,this.images.doherty,function(){menu.inkStory.dailyMenuChosen("doherty");},ig.system.width-352,ig.system.height-192));var fourthX=ig.system.width-192;var fourthY=ig.system.height-192;if(show.hughes){options[menu.Page.MAIN].push(new ss.MenuImageOption(menu,this.images.hughes,function(){menu.inkStory.dailyMenuChosen("hughes");},fourthX,fourthY));}
if(show.custer){options[menu.Page.MAIN].push(new ss.MenuImageOption(menu,this.images.custer,function(){menu.inkStory.dailyMenuChosen("custer");},fourthX,fourthY));}
