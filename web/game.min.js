...
this.setNextMoment(inkstory.getNextMoment(choiceIndex));});this.ink.tagHandlers["portrait"]=function(key,character,position){if(!position){if(character.toLowerCase()=="telegraph"){position="right";}else{position="center";}}
